...
var Controller = /** @class */ (function () {
    ...
    function Controller() {
        ...
        this.test_FENS = [
            new FEN("rnbq1rk1/ppp2ppp/3p1n2/4p3/1bP1P3/2N3P1/PP1PNPBP/R1BQK2R b KQ - 1 6 "),
            new FEN("r2q1rk1/pp2ppbp/1n3np1/3P4/P2P1N2/1QN5/1P3PPP/R1B1K2R b KQ - 2 13"),
        ];
     ...
     */
    Controller.prototype.setNameElement = function (name) {
     ...
     */
    Controller.prototype.getOpenRep = function () {
     ...
     * @returns a new rep
     */
    Controller.prototype.newRepertoire = function (name) {
     ...
     */
    Controller.prototype.editRepertoire = function () {
        ...
        var newRepItems = Array.from(document.getElementsByClassName("editRep"));
        //make them visible
        newRepItems.forEach(function (element) {
     ...
     */
    Controller.prototype.changeExampleGame = function (fen) {
...
export { Controller };
//# sourceMappingURL=repertoire-controller.mjs.map